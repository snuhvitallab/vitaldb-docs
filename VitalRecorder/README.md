...
|----------|----------|-------------|
| [User Manual](User_Manual.md) | EN | Full feature reference |
| [User Manual](User_Manual_Korean.md) | KO | |
...
| [Hardware Connection Guide](connection-guide/devices/README.md) | EN | Per-device connection instructions |
