...
2. Connect to the correct module slot — **NOT BP2** if using PLETH.
   ...
   <img src="hardware_images/ge_tram_rac_1.png" width="600" alt="Incorrect connection example">

3. Connect the ADC output (USB) to the PC.

   <img src="hardware_images/ge_tram_rac_2.png" width="600" alt="TRAM-RAC 4A — ANALOG OUT connector">
...
<img src="hardware_images/ge_tram_rac_3.png" width="600" alt="TRAM-RAC module slot reference">
