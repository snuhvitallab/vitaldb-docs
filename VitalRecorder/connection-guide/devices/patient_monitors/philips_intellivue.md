...
1. Prepare a cable connecting **RJ-45 pins 4, 5, 7** → **DB-9F pins 5, 2, 3**.
   ...
   <img src="hardware_images/philips_intellivue_5.png" width="600" alt="RJ-45 to DB-9F custom cable pinout">

2. Plug the **RJ-45 end** into the MIB port on the monitor.

   <img src="hardware_images/philips_intellivue_4.png" width="600" alt="MIB port location">
...
4. **MX400–550 series only:** Use the Advanced Interface Card (Rx/Tx pins connect differently).
   ...
   <img src="hardware_images/philips_intellivue_7.png" width="600" alt="MX400-550 Advanced Interface Card pinout">
...
1. Press **Main Setup → Operation Modes → Service**.
   ...
   <img src="hardware_images/philips_intellivue_6.png" width="600" alt="Main Setup → Operation Modes → Service">

2. Enter service password (default: **`1345`**). Contact manufacturer if this fails.

   <img src="hardware_images/philips_intellivue_8.png" width="600" alt="Password entry screen">
...
4. Set **Data Export 1** and **Data Export 2** baud rate to **"Fix 115200"**.
   ...
   <img src="hardware_images/philips_intellivue_3.png" width="288" alt="Data Export baud rate settings">

5. Press **Interfaces**.

   <img src="hardware_images/philips_intellivue_1.png" width="600" alt="Interfaces menu">

6. Verify port **01a** driver is set to **"DtOut1"**. If not, press **Change Driver → DtOut1**.

   <img src="hardware_images/philips_intellivue_2.png" width="600" alt="Port 01a — DtOut1 driver selection">
