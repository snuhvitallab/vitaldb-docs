...
2. Connect to **Defib.Sync** on the front panel per the pin diagram.
   ...
   <img src="hardware_images/ge_defib_1.png" width="186" alt="Defib.Sync port — pin diagram">

3. Connect the other end to the ADC, then connect the ADC to the PC via USB.

   <img src="hardware_images/ge_defib_2.png" width="600" alt="Defib connector wiring reference">
