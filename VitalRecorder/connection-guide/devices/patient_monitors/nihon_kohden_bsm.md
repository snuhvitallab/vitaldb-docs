...
1. Attach a **Null Modem (M/F)** to the serial port on the QI-373P board.
   ...
   <img src="hardware_images/nihon_kohden_bsm_1.png" width="600" alt="QI-373P board — serial port">
...
1. Plug the **ECG/BP output cable** (from Nihon Kohden) into the ECG/BP OUT port.
   ...
   <img src="hardware_images/nihon_kohden_bsm_3.png" width="600" alt="ECG/BP OUT port connection">

2. Fabricate a **5.5pi Mono to RJ45 cable** per the pin diagram to connect to the ADC.

   <img src="hardware_images/nihon_kohden_bsm_2.png" width="600" alt="5.5pi Mono to RJ45 pin diagram">

3. Connect the ADC to the PC via USB.

   <img src="hardware_images/nihon_kohden_bsm_4.png" width="600" alt="ADC connection to PC">
