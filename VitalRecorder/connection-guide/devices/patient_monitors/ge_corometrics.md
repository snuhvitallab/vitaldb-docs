...
<img src="hardware_images/ge_corometrics_2.png" width="161" alt="Setup button location">

1. Use the **UA Reference button** to activate settings for FHR or UA display.

   <img src="hardware_images/ge_corometrics_1.png" width="600" alt="UA Reference button">
